-- Share links expire. Missing expiresAt falls back to 14 days from created_at
-- so older links do not live forever. API keys are unchanged.
...
begin
  ...
  where a.metadata ->> 'keyHash' = p_token_hash
    ...
    and (
      a.type = 'api_key'
      or coalesce(
           nullif(a.metadata ->> 'expiresAt', '')::timestamptz,
